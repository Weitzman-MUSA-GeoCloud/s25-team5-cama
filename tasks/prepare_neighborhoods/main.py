...
def prepare_neighborhoods(request):
    ...
    print('Preparing Neighborhoods data')

    raw_filename = DATA_DIR / 'neighborhoods.geojson'
    prepared_filename = DATA_DIR / 'neighborhoods.jsonl'
    ...
    raw_blobname = 'neighborhoods/neighborhoods.geojson'
    ...
    prepared_blobname = 'neighborhoods/data.jsonl'
